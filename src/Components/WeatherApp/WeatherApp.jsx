...
const WeatherApp = () => {
  let api_key = "75d16b59877ac9dba16ce2c316a6e765";
  ...
  const search = async () => {
    ...
    const feelslike = document.getElementsByClassName("feels-temp");
    const country = document.getElementsByClassName("location-country");
  ...
  return (
    <div className="container">
      ...
      <div className="location-country">th</div>
      <div className="data-container">
        <div className="element">
          <img src={wicon} alt="" className="icon" />
          <div className="data">
            <div className="feels-temp">33°c</div>
